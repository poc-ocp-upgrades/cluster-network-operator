...
func TestRenderUnknownNetwork(t *testing.T) {
	...
	defer _logClusterCodePath()
	g := NewGomegaWithT(t)
	config := operv1.Network{Spec: operv1.NetworkSpec{ServiceNetwork: []string{"172.30.0.0/16"}, ClusterNetwork: []operv1.ClusterNetworkEntry{{CIDR: "10.128.0.0/15", HostPrefix: 23}, {CIDR: "10.0.0.0/14", HostPrefix: 24}}, DefaultNetwork: operv1.DefaultNetworkDefinition{Type: "MyAwesomeThirdPartyPlugin"}}}
