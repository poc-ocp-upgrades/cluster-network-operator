...
var ClusterConfig = configv1.NetworkSpec{ClusterNetwork: []configv1.ClusterNetworkEntry{{CIDR: "10.0.0.0/22", HostPrefix: 24}, {CIDR: "10.2.0.0/22", HostPrefix: 23}}, ServiceNetwork: []string{"192.168.0.0/20"}, NetworkType: "None"}
...
func TestStatusFromConfig(t *testing.T) {
	...
	g.Expect(status).To(Equal(configv1.NetworkStatus{ClusterNetwork: []configv1.ClusterNetworkEntry{{CIDR: "10.128.0.0/15", HostPrefix: 23}, {CIDR: "10.0.0.0/14", HostPrefix: 24}}, ServiceNetwork: []string{"172.30.0.0/16"}, ClusterNetworkMTU: 1300, NetworkType: "OpenShiftSDN"}))
}
